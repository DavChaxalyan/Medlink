<template>
    <div class="bg-[#E4ECF7] rounded-[0px_40px_40px_40px] pb-[112px]">
        <div class="flex flex-col gap-[24px] items-center pt-[80px]">
            <p
                class="max-w-[1103px] font-sans text-[96px] font-normal leading-[96px] tracking-[-0.06em] text-center text-[#1F2933]">
                Video Interview Session</p>
            <p
                class="max-w-[899px] font-sans text-[24px] font-normal leading-[28.8px] tracking-[-0.02em] text-center text-[#1F2933A3]">
        ...
        <div class="flex flex-col gap-[24px] items-center pt-[60px]">
            <p
                ...
                Question 2 of 4</p>
            <p
                class="max-w-[1140px] font-sans text-[32px] font-medium leading-[38.4px] tracking-[-0.02em] text-center text-[#1F2933]">
                Can you describe a challenging situation you faced in your role and how you handled it?</p>
        </div>
        <div class="flex gap-[117px] mt-[40px] items-center justify-center">
            <div class="flex flex-col">
                <div class="flex flex-col gap-[10px]">
                    <div
                        class="flex gap-[16px] py-[16px] px-[32px] bg-[white] rounded-[40px] border border-[#1F293314]">
                        <div
                            class="flex flex-col items-center justify-center gap-[5px] p-[8px_16px] rounded-[27px] border border-[#1F293314] bg-[#BAD8F14D]">
                        ...
                        <p
                            class="max-w-[426px] font-sans text-[20px] font-medium leading-[24px] text-left text-[#1F2933]">
                            How do you prioritize tasks when managing multiple projects at once?</p>
                    </div>
                    <div class="flex gap-[16px] py-[16px] px-[32px] bg-[white] rounded-[40px] border border-[#398B39]">
                        <div
                            class="flex flex-col items-center justify-center gap-[5px] p-[8px_16px] rounded-[27px] border border-[#1F293314] bg-[#BAD8F14D]">
                    ...
                    <div
                        class="flex flex-col gap-[24px] py-[16px] px-[32px] bg-[white] rounded-[40px] border border-[#1F293314]">
                ...
                <div class="mt-[80px]">
                    <div class="flex flex-col gap-[16px]">
                        <button
                            class="font-sans text-[16px] font-medium leading-[16px] text-left text-[#1F2933] w-[559px] h-[56px] p-[20px_32px] gap-[10px] rounded-[40px] border border-[#1F2933] flex items-center justify-center">Add
                            Question</button>
                        <button
                            class="font-sans text-[16px] font-medium leading-[16px] text-left text-[#1F2933] w-[559px] h-[56px] p-[20px_32px] gap-[10px] rounded-[40px] border border-[#1F2933] flex items-center justify-center">Submit</button>
                    </div>
                </div>
            </div>
            <div class="flex items-center flex-col gap-[24px]">
                <div
                    class="bg-[url('../../../src/assets/images/videiRecordReview.png')] rounded-[40px] w-[464px] h-[642px]">
        ...
        <div v-if="showDeletePopup"
            class="flex-col fixed inset-0 flex items-center justify-center bg-[#1F293314] backdrop-blur-24">
            <div>
                <div>
                    <img src="../../assets/images/delete-record-popup-img.png" alt="">
                </div>
                <div>
                    <div class="relative bg-white px-[48px] py-[48px] rounded-[0px_40px_40px_40px]">
                        ...
                        <div class="max-w-[753px]">
                            <p
                                class="text-[#1F2933] font-dm-sans text-[64px] font-normal leading-[64px] tracking-[-0.04em] text-left">
        ...
        <div v-if="showSettingsPopup"
            ...
            <div>
                ...
                <div>
                    <div class="relative bg-white px-[48px] pb-[156px] pt-[48px] rounded-[0px_40px_40px_40px]">
                        <div class="absolute top-[-10px]"><img src="../../assets/images/setting-popup-icon.png"
                                alt=""></div>
                        <div class="flex items-center justify-end">
                            <div class="w-[56px] h-[56px] p-4 gap-[10px] rounded-[40px] border-2 border-[#1F293314] flex items-center justify-center cursor-pointer"
                        ...
                        <div class="flex items-start gap-[64px] mt-[32px]">
                            <div
                                class="gap-[10px] rounded-[40px] font-dm-sans text-base font-medium leading-4 text-left text-[white] flex flex-col items-center justify-center"
                            >
                                <button @click="toggleActiveButton('audio')" class="w-[222px] h-[46px] p-[10px] gap-[10px] rounded-[20px] flex items-center" :class="activeButton === 'audio' ? 'bg-[#DAFF98] text-[#398B39]' : 'bg-[#ffffff] text-[#1F2933]'">
                                    <img v-if="activeButton === 'audio'" src="../../assets/images/microphone-recorder.png" alt="">
                                    <img v-else src="../../assets/images/inactive-microphone.png" alt="">
                                    Audio
                                </button>
                                <button @click="toggleActiveButton('video')" class="w-[222px] h-[46px] p-[10px] gap-[10px] rounded-[20px] flex items-center" :class="activeButton === 'video' ? 'bg-[#DAFF98] text-[#398B39]' : 'bg-[#ffffff] text-[#1F2933]'">
                                    <img v-if="activeButton !== 'video'" src="../../assets/images/video-recorder.svg" alt="">
                            ...
                            <div class="flex flex-col gap-[24px]">
                                <div v-if="activeButton !== 'video'" class="flex flex-col gap-[8px]">
                                    <p class="text-[#1F2933] font-dm-sans text-[14px] font-semibold leading-[20px] text-left">Microphone</p>
                                    <div class="border border-[#1F293314] p-[16px] gap-[25px] rounded-[24px] flex items-center">
                                        <div class="flex items-center gap-[8px]">
                                            <img src="../../assets/images/microphone-01.png" class="w-[20px] h-[20px]" alt="">
                                            <p class="text-[#1F2933] w-[257px] font-dm-sans text-[16px] font-normal leading-[20px] text-left">MacBook Pro Microphone (Buit-in)</p>
                                        </div>
                                        <div>
                                ...
                                <div v-if="activeButton !== 'video'" class="flex flex-col gap-[8px]">
                                    <p class="text-[#1F2933] font-dm-sans text-[14px] font-semibold leading-[20px] text-left">Speaker</p>
                                    <div class="border border-[#1F293314] p-[16px] gap-[25px] rounded-[24px] flex items-center">
                                        <div class="flex items-center gap-[8px]">
                                            <img src="../../assets/images/speaker-recorder.svg" alt="">
                                            <p class="text-[#1F2933] font-dm-sans text-[16px] w-[257px] font-normal leading-[20px] text-left">MacBook Pro Ызуфлукы (Buit-in)</p>
                                        </div>
                                        <div>
                                            <img src="../../assets/images/arrow-down-icon.png" alt="">
                                        </div>
                                ...
                                <div v-else class="flex flex-col gap-[8px]">
                                    <p class="text-[#1F2933] font-dm-sans text-[14px] font-semibold leading-[20px] text-left">Camera</p>
                                    <div class="border border-[#1F293314] p-[16px] gap-[25px] rounded-[24px] flex items-center">
                                        <div class="flex items-center gap-[8px]">
                                            <img src="../../assets/images/video-select-icon.svg" alt="">
                                            <p class="text-[#1F2933] font-dm-sans text-[16px] w-[257px] font-normal leading-[20px] text-left">FaceTime HD Camera</p>
                                        </div>
                                        <div>
                                            <img src="../../assets/images/arrow-down-icon.png" alt="">
                                        </div>
