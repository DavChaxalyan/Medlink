  ...
  <div class="mt-150px">
    <section class="bg-[#E4ECF7] pl-[134px] pr-[134px] mt-[150px]">
      <div class="pt-[80px] flex gap-[134px]">
        ...
        <p
          class="text-[20px] leading-[24px] font-medium max-w-[463px] text-[#1F2933A3]"
        >
      ...
      <div class="mt-[40px]">
        <div class="flex gap-[20px]">
          ...
          <div class="flex flex-col gap-[16px]">
            <div
              class="max-w-[554px] flex border border-[#1F293314] rounded-[40px] p-[24px]"
            >
              <div class="">
                <h3
                  class="text-[#1F2933] text-[24px] leading-[28.8px] font-medium max-w-[222px]"
                >
                  From Darkness to Light: Someone’s Battle with Depression
                </h3>
                <p
                  class="w-[100px] max-w-[222px] overflow-hidden whitespace-nowrap overflow-ellipsis"
                >
            ...
            <div
              class="max-w-[554px] flex flex-col border border-[#1F293314] rounded-[40px] p-[24px]"
            >
              ...
              <div>
                <div
                  class="w-[24px] h-[24px] bg-[#398B39] flex items-center justify-center rounded-[80px]"
                >
                  <img
                    class="w-[9px] h-[12px]"
                    src="../../assets/images/solid-play.png"
                    alt=""
                  />
                </div>
                <div class="flex items-center mt-[16px] gap-[8px]">
            ...
            <div
              class="max-w-[554px] flex flex-col gap-[16px] border border-[#1F293314] rounded-[40px] p-[24px]"
            >
              ...
              <p
                class="text-[#1F2933A3] font-medium text-[20px] rounded-[24px]"
              >
                Join Sarah as she opens up about her battle with depression,
                offering insights into the healing power of community and
                self-care.
